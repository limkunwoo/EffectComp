...
#include "EffectCompSportsCar.h"
#include "EffectCompSportsWheelFront.h"
#include "EffectCompSportsWheelRear.h"
#include  "EffectComponent/MVEffectComponent.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AEffectCompSportsCar::AEffectCompSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UEffectCompSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UEffectCompSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UEffectCompSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UEffectCompSportsWheelRear::StaticClass();
	...
	EffectComponent = CreateDefaultSubobject<UMVEffectComponent>(TEXT("Effect Component"));
}