...
#include "EffectCompOffroadCar.h"
#include "EffectCompOffroadWheelFront.h"
#include "EffectCompOffroadWheelRear.h"
...
AEffectCompOffroadCar::AEffectCompOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UEffectCompOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UEffectCompOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UEffectCompOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UEffectCompOffroadWheelRear::StaticClass();
