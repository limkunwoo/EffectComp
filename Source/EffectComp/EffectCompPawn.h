...
#include "EffectCompPawn.generated.h"
 ...
 */
UENUM()
enum class EVehicleEffect
{
	Braking,
};

UCLASS(abstract)
class AEffectCompPawn : public AWheeledVehiclePawn, public IEffectableActor
{
	GENERATED_BODY()
...
protected:
	virtual TArray<FName> GetEffectEventOptions() const override;
