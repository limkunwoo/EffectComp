...
#include "EffectCompPlayerController.generated.h"

class UInputMappingContext;
class AEffectCompPawn;
class UEffectCompUI;
 ...
 */
UCLASS(abstract)
class AEffectCompPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AEffectCompPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AEffectCompPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UEffectCompUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UEffectCompUI> VehicleUI;
