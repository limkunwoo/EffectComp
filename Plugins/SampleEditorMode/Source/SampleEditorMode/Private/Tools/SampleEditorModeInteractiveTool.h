...
#include "SampleEditorModeInteractiveTool.generated.h"


/**
 * Builder for USampleEditorModeInteractiveTool
 */
UCLASS()
class SAMPLEEDITORMODE_API USampleEditorModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the USampleEditorModeInteractiveTool
 */
UCLASS(Transient)
class SAMPLEEDITORMODE_API USampleEditorModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	USampleEditorModeInteractiveToolProperties();
...
/**
 * USampleEditorModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class SAMPLEEDITORMODE_API USampleEditorModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USampleEditorModeInteractiveToolProperties> Properties;
