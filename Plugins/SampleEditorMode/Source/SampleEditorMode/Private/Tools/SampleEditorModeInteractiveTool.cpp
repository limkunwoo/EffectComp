...
#include "SampleEditorModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "USampleEditorModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* USampleEditorModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	USampleEditorModeInteractiveTool* NewTool = NewObject<USampleEditorModeInteractiveTool>(SceneState.ToolManager);
...
USampleEditorModeInteractiveToolProperties::USampleEditorModeInteractiveToolProperties()
{
...
void USampleEditorModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void USampleEditorModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<USampleEditorModeInteractiveToolProperties>(this, "Measurement");
...
void USampleEditorModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit USampleEditorModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void USampleEditorModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void USampleEditorModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit USampleEditorModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void USampleEditorModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void USampleEditorModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void USampleEditorModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void USampleEditorModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
