...
#include "SampleEditorModeEditorMode.generated.h"
 ...
 */
UCLASS()
class USampleEditorModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_SampleEditorModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	USampleEditorModeEditorMode();
	virtual ~USampleEditorModeEditorMode();
